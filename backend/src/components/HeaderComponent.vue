<template>
    <header class="flex justify-between items-center p-3 h-14 shadow bg-white">
        <button @click="$emit('toggle-sidebar')"
                class="flex items-center justify-center rounded w-8 h-8
                       text-gray-700 hover:bg-black/10 transition-colors">

            <MenuIcon class="w-6"/>
        </button>
            <Menu as="div" class="relative inline-block text-left">
                    <MenuButton class="flex items-center">
                        <img src="https://randomuser.me/api/portraits/men/54.jpg" class="rounded-full w-10 mr-2">
                        <p>John Smith</p>
                        <ChevronDownIcon
...
<script setup>
import {Bars2Icon as MenuIcon, ArrowLeftOnRectangleIcon as Logout, UserIcon} from '@heroicons/vue/24/outline'
